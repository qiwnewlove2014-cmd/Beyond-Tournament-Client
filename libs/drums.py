...
class DrumAudio:
    ...
    KITS = {
        ...
        "diw": (
            ("Kick", "drums/DrumBy (Mr. Ling, Jik Jik)/Kick.ogg", 5.63, 6),
            ("Snare", "drums/DrumBy (Mr. Ling, Jik Jik)/snare1.ogg", 6.30, 6),
            ("Rim (Snare 2)", "drums/DrumBy (Mr. Ling, Jik Jik)/snare2.ogg", 6.30, 6),
            ("Closed Hi-Hat", "drums/DrumBy (Mr. Ling, Jik Jik)/hat c.ogg", 11.25, 8),
            ("Open Hi-Hat", "drums/DrumBy (Mr. Ling, Jik Jik)/hat o.ogg", 9.00, 4),
            ("Foot Hi-Hat", "drums/DrumBy (Mr. Ling, Jik Jik)/hat f.ogg", 13.50, 8),
            ("Tom 1", "drums/DrumBy (Mr. Ling, Jik Jik)/tom 1.ogg", 6.30, 6),
            ("Tom 2", "drums/DrumBy (Mr. Ling, Jik Jik)/tom 2.ogg", 6.30, 6),
            ("Tom 3", "drums/DrumBy (Mr. Ling, Jik Jik)/tom 3.ogg", 6.30, 6),
            ("Tom 4", "drums/DrumBy (Mr. Ling, Jik Jik)/tom 4.ogg", 6.30, 6),
            ("Crash Left", "drums/DrumBy (Mr. Ling, Jik Jik)/crash L.ogg", 9.00, 3),
            ("Crash Right", "drums/DrumBy (Mr. Ling, Jik Jik)/crash R.ogg", 9.00, 3),
            ("China", "drums/DrumBy (Mr. Ling, Jik Jik)/CN.ogg", 7.88, 3),
            ("Splash", "drums/DrumBy (Mr. Ling, Jik Jik)/Sp.ogg", 7.88, 3),
            ("Ride", "drums/DrumBy (Mr. Ling, Jik Jik)/ride.ogg", 10.13, 4),
            ("Ride Bell", "drums/DrumBy (Mr. Ling, Jik Jik)/bell.ogg", 10.13, 4),
            ("Cowbell", "drums/DrumBy (Mr. Ling, Jik Jik)/Cabell lum.ogg", 9.00, 6),
            ("Rim", "drums/DrumBy (Mr. Ling, Jik Jik)/rim.ogg", 6.75, 6),
        ),
    }
    DEFAULT_KIT = "default"
